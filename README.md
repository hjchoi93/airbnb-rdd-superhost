...
The confidence intervals for every bandwidth-rating combination included zero. This means we don't have strong enough statistical evidence to rule out no jump/discontinuity. **In other words, there is insufficient statistical evidence that the cutoff rating at 4.8 causes a significant increase in bookings.**
